...
var AJAX = {
  ...
  requestHandler(event) {
    ...
    if (typeof event !== 'undefined' && (event.shiftKey || event.ctrlKey)) {
      ...
      return true;
    } if ($(this).hasClass('ajax') || $(this).hasClass('disableAjax')) {
  ...
  responseHandler(data) {
    ...
    if (typeof data.success !== 'undefined' && data.success) {
      ...
      AJAX.scriptHandler.reset(() => {
        ...
        if (data._selflink) {
          const source = data._selflink.split('?')[0];
          ...
          if ($selflink_replace[source]) {
            const replacement = $selflink_replace[source];
        ...
        if (data._errors) {
          ...
          $('#pma_ignore_errors_bottom').on('click', (e) => {
            e.preventDefault();
            PMA_ignorePhpErrors();
          });
          $('#pma_ignore_all_errors_bottom').on('click', (e) => {
            e.preventDefault();
          ...
          if (data._sendErrorAlways === '1'
            ...
            msg += PMA_messages.phpErrorsFound;
        ...
        $('#pma_ignore_errors_popup').on('click', () => {
          PMA_ignorePhpErrors();
        });
  ...
  scriptHandler: {
    ...
    /**
         ...
         */
    reset(callback) {
      for (const i in this._scriptsToBeFired) {
...
$(() => {
  ...
  if (history && history.pushState) {
    ...
    $(window).on('popstate', (event) => {
      ...
      if (state && state.menu) {
        AJAX.$msgbox = PMA_ajaxShowMessage();
        const params = `ajax_request=true${PMA_commonParams.get('arg_separator')}ajax_page_request=true`;
    ...
    AJAX.scriptHandler
      .load([{ name: 'microhistory.js', fire: 1 }], () => {
